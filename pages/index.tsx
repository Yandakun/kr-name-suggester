...
import Image from 'next/image'; // We are re-importing the official <Image> component
...
const Home: NextPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    setIsLoading(true);
    setMessage('Finding the perfect name for you...');
    setRecommendation(null);
      ...
      <main className="w-full max-w-sm">
        {recommendation ? (
          ...
          <InputForm
            ...
            photo={photo} handlePhotoChange={handlePhotoChange}
...
// --- Input Form Sub-Component (No changes) ---
const InputForm = ({ gender, setGender, age, setAge, photo, handlePhotoChange, isLoading, message, handleSubmit }: any) => (
...
// --- Result Card Sub-Component (Using <Image />) ---
